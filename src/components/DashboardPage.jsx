    ...
    <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, zIndex: 0, overflow: 'hidden' }}>
        <svg width="100%" height="100%" viewBox="0 0 1440 1024" preserveAspectRatio="xMidYMid slice">
            <g fillRule="evenodd" fillOpacity="0.4">
                ...
                <g fill="#05705a">
                    {/* Green circle peeking from mid-left, moved further down and larger */}
                    <circle cx="-150" cy="650" r="320" />
                </g>

                {/* Shapes on the RIGHT side */}
                <g fill="#ebad1c">
                     {/* Yellow triangle in the top right, now clearly pointing inward */}
                    <path d="M1440 0 L1440 300 L1100 0 Z" />
                </g>
                <g fill="#7847DC">
                    {/* Purple polygon peeking from bottom-right, moved down */}
                    <path d="M1440 700 L1200 850 L1250 1150 L1440 1080 Z" />
                </g>
            </g>
        </svg>
    </div>
...
const MaturityScoreVisual = ({ score }) => {
    // This component's implementation is unchanged.
    const gaugeConfig = {
